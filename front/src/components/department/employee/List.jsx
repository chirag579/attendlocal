...
const List = () => {
  ...
  const fetchProjectsByEmployee = async (empId) => {
    try {
      const response = await axios.get(`https://attendlocalserv.vercel.app/api/employee/projects/${empId}`, {
        headers: {
  ...
  const fetchEmployees = async () => {
    setEmpLoading(true);
    try {
      const response = await axios.get("https://attendlocalserv.vercel.app/api/employee", {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
        },
      });
            ...
            return {
              ...
              profileImage: emp.userId?.profileImage ? (
                <img
                  ...
                  src={`https://attendlocalserv.vercel.app/${emp.userId.profileImage}`}
                  alt={emp.userId.name}
                />
              ) : null,
